...
vim.keymap.set('n', '<leader>ds', ':lua vim.diagnostic.open_float()<cr>',
  { silent = true, desc = "Show line diagnostic" })
vim.keymap.set('n', '<leader>db', ':lua vim.diagnostic.setloclist()<cr>',
...
vim.keymap.set('n', '<leader>dj', ':lua vim.diagnostic.goto_next()<cr>',
  { silent = true, desc = "Go to next diagnostic" })
vim.keymap.set('n', '<leader>dk', ':lua vim.diagnostic.goto_prev()<cr>',
  { silent = true, desc = "Go to prev diagnostic" })
