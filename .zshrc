...
# Verifica se GHCUP_INSTALL_BASE_PREFIX está definido, se não, define como $HOME
if [ -z "$GHCUP_INSTALL_BASE_PREFIX" ]; then
    export GHCUP_INSTALL_BASE_PREFIX="$HOME"
fi
# Adiciona os diretórios ao PATH
export PATH="$HOME/.cabal/bin:/home/luinel/.ghcup/bin:$PATH"

export PATH=$PATH:$HOME/go/bin

export PATH="$PATH:/home/luinel/.dotnet/tools"
